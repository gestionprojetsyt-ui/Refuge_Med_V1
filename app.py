...
# --- 2. LA POP-UP (RÉCENTE EN HAUT, VIEILLE EN BAS + SÉPARATEURS) ---
@st.dialog("📢 ÉVÉNEMENTS AU REFUGE", width="large")
def afficher_evenements(liste_urls):
    # Inversion : la dernière ligne du Excel arrive en premier (en haut)
...
try:
    ...
    # --- 6. RÉCUPÉRATION DU PIED DE PAGE DÉTAILLÉ ---
    st.markdown("""
