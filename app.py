...
# --- 2. FONCTION PDF (AVEC BADGE SENIOR ET DON LIBRE) ---
...
def generer_pdf(row):
    try:
        ...
        try:
            ...
            # Petit badge en coin sur la photo si Senior
            if is_senior:
        ...
        # Mention Don Libre (Bandeau sous la photo)
        if is_senior:
            pdf.set_fill_color(255, 249, 196) # Jaune clair
            pdf.set_text_color(133, 100, 4)   # Marron
    ...
    st.markdown("""
        <div class="footer-container">
            ...
            <div style="font-size:0.85em; color:#666; margin-top:15px; padding-top:15px; border-top:1px solid #ddd;">
                ...
                <div style="font-style: italic; margin-top:5px; font-size:0.8em;">Version 3.0 - SOS Senior & Badge PDF</div>
            </div>
        </div>
    """, unsafe_allow_html=True)
